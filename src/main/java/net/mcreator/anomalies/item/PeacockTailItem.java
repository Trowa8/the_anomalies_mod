...
public abstract class PeacockTailItem extends ArmorItem {
	public PeacockTailItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForType(ArmorItem.Type type) {
				return new int[]{4, 10, 10, 4}[type.getSlot().getIndex()];
			}
			...
			public SoundEvent getEquipSound() {
				return ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("block.bamboo.hit"));
			}
	...
	public static class Chestplate extends PeacockTailItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "anomalies:textures/entities/peacock_tail_texture.png";
		}
	}
}